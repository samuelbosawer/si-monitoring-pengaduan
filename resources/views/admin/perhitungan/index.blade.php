...
let districtLayers = {
    "C1 (Hijau)": L.layerGroup(),
    "C2 (Biru)": L.layerGroup(),
    "C3 (Merah)": L.layerGroup()
};
...
maps.forEach((mapData, index) => {
    try {
        ...
        if (c1_result < c2_result && c1_result < c3_result) {
            ...
            ket = 1;
            color = "#00FF00"; // Hijau
            categoryLayer = districtLayers["C1 (Hijau)"];
        }
        ...
        if (c2_result < c1_result && c2_result < c3_result) {
            ...
            ket = 2;
            color = "#0000FF"; // Biru
            categoryLayer = districtLayers["C2 (Biru)"];
        }
        ...
        if (c3_result < c1_result && c3_result < c2_result) {
            ...
            ket = 3;
            color = "#FF0000"; // Merah
            categoryLayer = districtLayers["C3 (Merah)"];
        }
        ...
        if (geoJsonData && geoJsonData.type === "FeatureCollection") {
            ...
            let geoLayer = L.geoJson(geoJsonData, {
                ...
                onEachFeature: (feature, layer) => {
                    ...
                    layer.bindPopup(`${namaWilayah} (Clustering: ${ket})`);
                }
            });

            geoLayer.addTo(categoryLayer);
        } else {
