                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <textarea  id="summernote" @if (Request::segment(3) == 'detail') disabled @endif name="geojson"
                                                            placeholder="Masukan geojson" rows="5" class="form-control">{{ old('geojson') ?? ($data->geojson ?? '') }} </textarea>
                                                    </div>
                                                </div>
                                            </div>
