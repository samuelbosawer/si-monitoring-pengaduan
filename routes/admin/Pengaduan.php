...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::controller(PengaduanController::class)->group(function(){
        ...
        Route::get('pengaduan/pdf-index', [PengaduanController::class, 'pdf_index'])->name('pengaduan.pdf_index')->middleware(['role:kepaladinas']);
        Route::get('pengaduan/pdf-detail/{id}', [PengaduanController::class, 'pdf_detail'])->name('pengaduan.pdf_detail')->middleware(['role:kepaladinas']);
