...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::controller(PengaduanController::class)->group(function(){
        ...
        Route::get('pengaduan/pdfdetail/cetak/{id}', [PengaduanController::class, 'pdfdetail'])->name('pengaduan.pdf.detail')->middleware(['role:kepalabidang|kepaladinas|pendampingdinas']);
